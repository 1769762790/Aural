...
export const MediaDetailView = ({
  ...
  return (
    <div className="space-y-10">
      <div className="sticky top-0 z-20 -mx-2 flex items-center px-2 py-1 backdrop-blur-md supports-[backdrop-filter]:bg-background/28">
        <Button
          type="button"
          variant="ghost"
          className="h-11 rounded-full border border-border bg-background/82 px-4 text-muted-foreground shadow-[0_12px_30px_rgba(15,23,42,0.08)] hover:bg-accent/45 hover:text-foreground"
          onClick={onBack}
        >
      ...
      <section className="grid gap-8 xl:grid-cols-[320px_minmax(0,1fr)] xl:items-center">
        ...
        <div className="space-y-6">
          <div className="space-y-3">
            ...
            <h1 className="max-w-[20ch] text-[45px] font-black leading-[0.92] tracking-[-0.08em] text-foreground truncate w-full">{title}</h1>
