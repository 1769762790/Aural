...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[26px] border border-border bg-card/90 text-card-foreground shadow-[0_18px_48px_rgba(0,0,0,0.1)] backdrop-blur-xl dark:shadow-[0_24px_80px_rgba(0,0,0,0.38)]",
      className
    )}
    {...props}
  />
