...
>(({ className, ...props }, ref) => (
  <AvatarPrimitive.Fallback
    ref={ref}
    className={cn(
      "flex size-full items-center justify-center bg-gradient-to-br from-primary/80 via-violet-400/60 to-cyan-300/70 text-xs font-semibold text-primary-foreground",
      className
    )}
    {...props}
  />
